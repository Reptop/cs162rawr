...
void Linked_List::sort_ascending() {
  // sort the nodes in ascending order. You must implement the recursive Merge
  // Sort algorithm Note: it's okay if sort_ascending() calls a recursive
  // private function to perform the sorting. Your code goes here:
